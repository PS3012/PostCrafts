          ...
          <>
               ...
               <div className="text-gray-700 bg-white shadow bg-clip-border rounded-xl">
                    <div className="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-white bg-clip-border rounded-xl h-52">
                         <img
                              src={_props.image} alt={_props.name}
                              className="object-cover w-full h-full"
                         />
                    </div>
                    <div className="px-6 py-4">
                         <div className="flex items-center justify-between mb-2">
                              <p className="block antialiased font-medium leading-relaxed text-blue-gray-900">{_props.name}</p>
                              <p className="block antialiased font-medium leading-relaxed text-blue-gray-900">INR {_props.price}</p>
                         </div>
