          ...
          <>
               ...
               <section className="bg-white">
                    <div className="grid grid-cols-1 lg:grid-cols-2 h-screen">
                         <div className="relative flex items-end px-4 pb-10 pt-48 sm:pb-16 md:justify-center lg:pb-24 bg-gray-50 sm:px-6 lg:px-8">
                              <div className="absolute inset-0">
                                   <img className="object-cover w-full h-full" src="/images/register.jpg" alt="" />
                              </div>
                                   ...
                                   <div className="space-y-3 mt-5 mb-0">
                                        <div>
                                             ...
                                             <div className="mt-1 relative text-gray-400 focus-within:text-gray-600">
                                                  ...
                                                  <input
                                                       type="text" placeholder="Enter your full name" name="name" value={data.name} onChange={handleDataChange}
